...
`MacOS binary <https://github.com/c-arthurs/QuArray/releases/download/v0.5/QuArray_macos_catalina.app.zip>`
...
To get started, download the latest stable version of the
`Windows binary <https://github.com/c-arthurs/QuArray/releases/download/v0.5/QuArray_windows7_8_10.exe>`
